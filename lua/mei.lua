...
function mei.load_syntax()
	local syntax = {
		...
		LineNr = { fg = mei.keyword_color, bg = mei.bg_alt },
		Visual = { fg = mei.bg, bg = mei.keyword_color },
		VisualNOS = { bg = mei.keyword_color },
		...
		IncSearch = { fg = mei.fg, bg = mei.pink, style = mei.none },
		...
		PmenuSel = { fg = mei.bg_popup, bg = mei.keyword_color },
...
function mei.load_plugin_syntax()
	local plugin_syntax = {
		...
		-- Telescope
		TelescopeBorder = { fg = mei.keyword_color },
